...
export const STEP_CONFIGS_MAP = {
  ...
  // Map legacy image step types to IMAGE_STEP_CONFIG for backwards compatibility
  [NodeTypes.GENERATE_IMAGE]: IMAGE_STEP_CONFIG,
  [NodeTypes.EDIT_IMAGE]: IMAGE_STEP_CONFIG,
  [NodeTypes.UPSCALE_IMAGE]: IMAGE_STEP_CONFIG,
  [NodeTypes.VIRTUAL_TRY_ON]: IMAGE_STEP_CONFIG,
};
